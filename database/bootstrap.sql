...
BEGIN
  ...
  END IF;
  FOREACH r IN ARRAY ARRAY['ci_owner','ci_auth_runtime','ci_routing_reader','ci_business_runtime'] LOOP
    ...
    END IF;
  END LOOP;
  FOREACH r IN ARRAY ARRAY['ci_auth_runtime','ci_routing_reader','ci_business_runtime'] LOOP
...
GRANT CONNECT ON DATABASE :"shard_db" TO ci_business_runtime;
